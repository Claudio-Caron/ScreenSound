...
public static class ArtistasExtensions
{
    public static void AddEndPointsArtistas(this WebApplication app)
    {
        ...
        {
            var artista = dalArtista.RecuperarPor(x=>x.Id == request.ArtistaId);
            ...
            var avaliacao = artista.AvaliacoesArtista.FirstOrDefault(a => a.ArtistaId == artista.Id
            && a.PessoaId == pessoa.Id);
            if (avaliacao is null)
            {
                artista.AdicionarNotaArtista(request.Nota, pessoa.Id);
            }
            else
            {
